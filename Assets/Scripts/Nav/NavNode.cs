...
public class NavNode : MonoBehaviour
{
    ...
    {
        return(neighbors.Count > 0) ? neighbors[UnityEngine.Random.Range(0, neighbors.Count)] : null;
    }
    ...
    public static NavNode GetRandomNavNode()
    {
        ...
        return (navNodes == null) ? null : navNodes[UnityEngine.Random.Range(0, navNodes.Length)];
    }
